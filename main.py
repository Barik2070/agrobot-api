...
def add_row(data: AddRowRequest):
    ...
    key_map = {}
    possible_matches = {
        "назва": ["назва", "ім'я", "компанія"],
        "область": ["область", "регіон"],
        "район": ["район"],
        "площа": ["площа", "га", "hectares"],
        "показники": ["культури", "продукція", "посіви"],
        "контакти": ["контакт", "телефон", "особа"],
        "нотатка": ["нотатки", "примітка"]
    }
